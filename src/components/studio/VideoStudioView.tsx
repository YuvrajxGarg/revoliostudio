...
export function VideoStudioView() {
  ...
  return (
    <div className="flex-1 flex min-h-0 gap-3 px-3 pb-3 pt-3">
      ...
      {/* max-h + overflow keeps a tall composer from covering the whole
          phone screen — safe now that Dropdown menus portal to <body>
          instead of being clipped by this scroll container. */}
      <div className="lg:hidden fixed inset-x-0 bottom-0 shrink-0 max-h-[70vh] overflow-y-auto border-t border-border-subtle bg-background/95 backdrop-blur px-4 py-3 z-10">
